//Se crean cuatro enumeraciones que servir�n para dar mayor legibilidad al c�digo
...
class item{
    protected:
        ...
        float x; //coordenada en X (basta con este dato por estar en 1 dimensi�n)
    ...
    public:
        ...
        //M�todos abstractos para instanciar los atributos de acuerdo a las necesidades
...
//Clase que representa una condici�n impuesta en un nodo de la malla
...
class mesh{
    ...
    public:
        //M�todo para instanciar el arreglo de par�metros, almacenando los
        ...
        //M�todo para instanciar el arreglo de cantidades, almacenando la cantidad
        ...
        //M�todo para obtener una cantidad en particular
        int getSize(int s){
            return sizes[s];
        }

        //M�todo para obtener un par�metro en particular
        float getParameter(int p){
            return parameters[p];
        }

        //M�todo para instanciar los cuatro atributos arreglo, usando
        ...
        //M�todo para obtener un nodo en particular
        node getNode(int i){
            return node_list[i];
        }

        //M�todo para obtener un elemento en particular
        element getElement(int i){
            return element_list[i];
        }

        //M�todo para obtener una condici�n en particular
        ...
        //M�todos posiblemente a utilizar en un futuro
